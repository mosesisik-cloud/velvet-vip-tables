...
function socialTrustCopy() {
  const copy = {
    sv: {
      eyebrow: "SOCIAL TRUST", title: "Din sociala verifiering", preview: "Förhandsprofil · ej verifierad", verified: "Socialt konto verifierat",
      ...
      waiting: "Väntar på riktig OAuth", needPass: "Passverifiering krävs", launch: "OAuth aktiveras när VELVETs plattformsappar är godkända.",
      demo: "Demo · ej verifierad", create: "Skapa förhandsprofil med",
    },
    en: {
      eyebrow: "SOCIAL TRUST", title: "Your social verification", preview: "Preview profile · unverified", verified: "Social account verified",
      ...
      waiting: "Waiting for real OAuth", needPass: "Passport verification required", launch: "OAuth activates when VELVET’s platform apps are approved.",
      demo: "Demo · unverified", create: "Create preview profile with",
    },
    es: {
      eyebrow: "SOCIAL TRUST", title: "Tu verificación social", preview: "Perfil de prueba · sin verificar", verified: "Cuenta social verificada",
      ...
      waiting: "Esperando OAuth real", needPass: "Se requiere verificación de pasaporte", launch: "OAuth se activa cuando las apps de VELVET estén aprobadas.",
      demo: "Demo · sin verificar", create: "Crear perfil de prueba con",
    },
    fr: {
      eyebrow: "SOCIAL TRUST", title: "Votre vérification sociale", preview: "Profil aperçu · non vérifié", verified: "Compte social vérifié",
      ...
      waiting: "En attente du véritable OAuth", needPass: "Vérification du passeport requise", launch: "OAuth sera activé lorsque les apps VELVET seront approuvées.",
      demo: "Démo · non vérifié", create: "Créer un profil aperçu avec",
    },
  };
...
function socialVerificationHTML(u) {
  ...
  const oauthOk = u?.socialVerification === "verified" || u?.socialOAuthVerified === true;
